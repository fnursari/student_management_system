...
public class AdvisoryTeacherService {
    ...
    public void updateAdvisoryTeacher(boolean status,Teacher teacher){
        ...
        Optional<AdvisoryTeacher> advisoryTeacher = advisoryTeacherRepository
                .getAdvisoryTeacherByTeacher_Id(teacher.getId());
        ...
        if(advisoryTeacher.isPresent()){
            //will be this new updated teacher really advisory teacher
            if (status){
