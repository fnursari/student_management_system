...
public class Messages {
    ...
    public static final String NOT_PERMITTED_METHOD_MESSAGE = "You do not have any permission to do";
    ...
    public static final String ALREADY_REGISTER_MESSAGE_SSN = "Error: User with username %s is already registered";
